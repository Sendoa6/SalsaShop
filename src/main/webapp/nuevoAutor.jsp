...
<head>
    <meta charset="UTF-8">
    <title>SalsaShop - Añadir Autor</title>
    <style>
...
<body>
    ...
    <div class="form-container">
        ...
        <form action="SrvNuevoAutor" method="post">
            <div class="form-group">
                <label>Nombre del Autor:</label>
                <input type="text" name="nombre_autor" placeholder="Ej: Gabriel García Márquez" required>
            </div>
            <button type="submit" class="btn-guardar">Registrar Autor</button>
