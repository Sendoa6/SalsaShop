...
<head>
    <meta charset="UTF-8">
    <title>SalsaShop - Añadir Categoría</title>
    <style>
...
<body>
    ...
    <div class="form-container">
        ...
        <form action="SrvNuevaCategoria" method="post">
            <div class="form-group">
                <label>Nombre de la Categoría:</label>
                <input type="text" name="nombre_categoria" placeholder="Ej: Novela, Terror, Cocina..." required>
            </div>
